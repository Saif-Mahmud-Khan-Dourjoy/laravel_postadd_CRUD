        ...
        <form method="post" action="{{url('update-post/'.$posts->id)}}" enctype="multipart/form-data">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="text" class="form-control" value="{{ $posts->title}}" placeholder="Title" id="title" name="title" >
          ...
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              ...
              <div>
                Old Image: <img src="{{URL::to($posts->image)}}" style="height: 40px; width: 50px; ">
              </div>
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Details</label>
              <textarea rows="5" class="form-control" placeholder="Details" id="details" name="details">{{ $posts->details }}</textarea>
